        ...
        <div class="!px-10 !py-12 card-body">
            ...
            <form action="{{ route('login.login') }}" class="mt-10" id="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="email" name="email" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" value="{{ old('email') }}" placeholder="Enter username or email">
                    @error('email')
                        <div id="username-error" class="mt-1 text-sm text-red-500">Please enter a valid email address.</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    @error('password')
                        <div id="password-error" class="mt-1 text-sm text-red-500">Password must be at least 8 characters long and contain both letters and numbers.</div>
                    @enderror
                </div>
                <div>
